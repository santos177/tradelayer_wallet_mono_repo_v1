<template>
  <div id="HistoricalTradesContainer">
     <div class="md-layout md-gutter md-alignment-center-space-between">
       <div class="md-layout-item md-small-hide">
         <md-tabs md-sync-route>
           ...
           <md-tab id="tab-account" md-label="Send" to="/HistoricalTrades"></md-tab>
...
<script>
// import buysell panel
import HistoricalTrades from '@/components/HistoricalTrades'
import BuySell from '@/components/BuySell'

export default {
  name: 'HistoricalTradesContainer',
  components: {HistoricalTrades, BuySell}
}
</script>
